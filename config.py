...
PSY_DONOR_CHANNELS = [
    'psy_trader',        # Психологія трейдингу
    'tradepsy',          # Ментальні ловушки в трейдингу
    'trade_mindset',     # Психологія ринків
    'FOMO_psy',          # Синдром упущенной выгоды (FOMO)
    'psy_fact',          # Короткі психологічні факти
    'psy_people',        # Практична психологія стосунків
    'psyhologia_dnia'    # Психотерапія та саморозвиток
]
...
# Сигнатура з посиланням на бібліотекаря в кінці постів психології
PSY_SIGNATURE = "\n\n📚 <b>Отримати безкоштовні книги та чек-листи з психології:</b> @librar_ian_bot"
