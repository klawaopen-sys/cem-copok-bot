...
# ---------------------------------------------------------------------
API_ID = int(os.getenv("API_ID", "37335025"))
API_HASH = os.getenv("API_HASH", "65354c57d6e3f7691120cf1e55b46fdc")
...
PSY_BOT_TOKEN = os.getenv("PSY_BOT_TOKEN", "6557362587:AAHmNbPuhKI9swW96m7ou4B-4fBhcuzVbdI") # Бот-психолог (@bbig333_bot)
GROQ_API_KEY = os.getenv("GROQ_API_KEY", "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") # Ключ для Groq (Whisper)
GROQ_MODEL = os.getenv("GROQ_MODEL", "whisper-large-v3-turbo") # Модель транскрибації
...
# ---------------------------------------------------------------------
BOT_TOKEN = os.getenv("BOT_TOKEN", "7394557878:AAEAn_wnrNGRVDmlcG_iUwTaeM94go-te3A") # Бот-постер для трейдингу
...
# ---------------------------------------------------------------------
LIBRARIAN_BOT_TOKEN = os.getenv("LIBRARIAN_BOT_TOKEN", "7256816649:AAEM2RdvGCkDjycNZemp3oeM0DyqqA-5IDo")
...
# Глобальна асинхронна сесія aiohttp
session = None
