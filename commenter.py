...
def get_gemini_comment(post_text):
    ...
    try:
        ...
        prompt = (
            ...
            "Напиши короткий, змістовний і максимально природний коментар (1-2 речення українською мовою) до наступного поста. "
            "Коментар має виглядати так, ніби його написала жива людина в Telegram-чаті (простий, розмовний і вільний стиль, без зайвої офіційності).\n\n"
            "КРИТИЧНО ВАЖЛИВЕ ПРАВИЛО:\n"
            "Обов'язково закінчуй свій коментар коротким, природним та залучаючим питанням до учасників чату, щоб спровокувати обговорення "
            "(наприклад: 'Як думаєте, полетимо вище чи це чергова пастка для биків?', 'Хтось уже купував на цьому проливі чи чекаємо нижче?', "
            "'Які думки, розвернемось від поточних чи це локальний відскік?', 'Чи є тут ті, хто тримає цей щиток?').\n\n"
            "Суворі обмеження:\n"
