...
def get_gemini_comment(post_text):
    ...
    try:
        ...
        prompt = (
            ...
            "ВАЖЛИВО: Напиши коментар ТІЄЮ Ж МОВОЮ, якою написаний сам пост (наприклад, якщо пост англійською — пиши англійською, якщо російською — російською, якщо українською — українською). Коментар має виглядати так, ніби його написала жива людина в Telegram-чаті (простий, розмовний і вільний стиль без зайвої офіційності).\n\n"
            ...
            "(наприклад, якщо пишеш українською: 'Як думаєте, полетимо вище чи це чергова пастка для биків?', якщо російською: 'Как думаете, пойдем выше или это ловушка?', якщо англійською: 'Do you think we are going higher or is it a trap?').\n\n"
            "Суворі обмеження:\n"
